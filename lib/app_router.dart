...
import 'package:move_sketch/pages/settings/setting_blocked_user.dart';
import 'pages/shell/move_sketch_shell.dart';
import 'pages/auth/landing_page.dart';
import 'pages/shell/home_page.dart';
import 'pages/session/session_start_page.dart';
import 'pages/session/session_tracking_page.dart';
import 'pages/session/session_result_page.dart';
import 'pages/session/session_share_page.dart';
import 'pages/feed/feed_page.dart';
import 'pages/feed/feed_post_page.dart';
import 'pages/feed/feed_notifications_page.dart';
import 'pages/history/history_page.dart';
import 'pages/history/history_details_page.dart';
import 'pages/profile/my_page.dart';
import 'pages/friends/friends_list_page.dart';
import 'pages/friends/user_search_page.dart';
import 'pages/profile/user_profile_page.dart';
import 'pages/settings/settings_page.dart';
import 'pages/settings/setting_account_page.dart';
import 'pages/settings/modify_password_page.dart';
import 'pages/settings/change_character_page.dart';
import 'pages/settings/setting_notifications_page.dart';
import 'pages/settings/oss_licenses_page.dart';
import 'pages/settings/privacy_page.dart';
import 'pages/settings/term_of_service_page.dart';
